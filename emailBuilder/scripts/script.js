...
for(let i=0; i<recipents.length; i++) {
    recipents[i].addEventListener("click", () => {
        ...
        p.setAttribute("class", "generatedText");
        p.setAttribute("id", "recipentsText");
        p.textContent = text;
...
for(let i=0; i<examples.length; i++) {
    examples[i].addEventListener("click", () => {
        ...
        let p = document.createElement("p");
        p.setAttribute("class", "generatedText");
        p.setAttribute("id", "examplesText");
        p.textContent = text;
...
for(let i=0; i<greetings.length; i++) {
    greetings[i].addEventListener("click", () => {
        ...
        let p = document.createElement("p");
        p.setAttribute("class", "generatedText");
        p.setAttribute("id", "greetingsText");
        p.textContent = text;
